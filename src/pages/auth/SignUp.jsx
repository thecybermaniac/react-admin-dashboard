...
const SignUp = () => {
  ...
  async function submit() {
    ...
    try {
      ...
      return navigate(`/auth/verify-email?user=${user.email}`);
    } catch (err) {
      console.log(err);
    } finally {
      setIsLoading(false);
  ...
  return (
    <div className="flex flex-col flex-1 w-full overflow-y-auto lg:w-1/2 no-scrollbar min-h-screen justify-center">
